...
import type { Cidadao, DadosRelatorio } from "@/types/electron";
import { listarCidadaosPaginado } from "@/modules/cidadaos/services/cidadaosService";
...
export function RelatorioCidadaos() {
  const [itens, setItens] = useState<Cidadao[]>([]);
  ...
  function gerarDados(): DadosRelatorio {
    return {
      ...
      linhas: itens.map((c) => ({
        ...
        bairro: c.bairro ?? "-",
        endereco: c.endereco ?? "-",
        nascimento: formatarData(c.dataNascimento),
      })),
    };
  }
  ...
  return (
    <div className="text-emerald-900">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-xl font-semibold">Relatório de Cidadãos</h1>
